...
boxplot(data.table(fourSitesModel.Wind$DT$sigma, genModel.Wind$DT$sigma),outline = F, ylim = c(2,4), col = cols, border = cols)
mtext('σ (mm/day)', side = 2, line = 3, cex = 1, font = 2)
boxplot(data.table(fourSitesModel.Wind$DT$abs, genModel.Wind$DT$abs), outline = F, ylim = c(0.45,.60), col = cols, border = cols)
mtext('αCan', side = 2, line = 3, cex = 1, font = 2)
boxplot(data.table(fourSitesModel.Wind$DT$eSky, genModel.Wind$DT$eSky), outline = F, ylim = c(.6,.9), col = cols, border = cols)
mtext('ϵSky', side = 2, line = 3, cex = 1, font = 2)
boxplot(data.table(fourSitesModel.Wind$DT$eSur, genModel.Wind$DT$eSur), outline = F, ylim = c(.93,1), col = cols, border = cols)
...
boxplot(data.table(fourSitesModel.Wind$DT$Aconv, genModel.Wind$DT$Aconv), outline = F, ylim = c(.5, .8), col = cols, border = cols)
mtext('Aconv', side = 2, line = 3, cex = 1, font = 2)
boxplot(data.table(fourSitesModel.Wind$DT$Cconv, genModel.Wind$DT$Cconv), outline = F, ylim = c(12, 22), col = cols, border = cols)
